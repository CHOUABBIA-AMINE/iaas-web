...
const GroupList = () => {
  ...
  const handleExportCSV = () => { exportToCSV(groups, 'groups'); setSuccess('Exported to CSV'); handleExportMenuClose(); };
  const handleExportExcel = () => { exportToExcel(groups, 'groups'); setSuccess('Exported to Excel'); handleExportMenuClose(); };
  const handleExportPDF = () => { exportToPDF(groups, 'groups', t); setSuccess('Exported to PDF'); handleExportMenuClose(); };
  ...
  return (
    <Box>
      <Box sx={{ mb: 3 }}>
        ...
        <Typography variant="body2" color="text.secondary">Manage groups and user assignments</Typography>
      </Box>
