/**
 * Structure Edit Page
 * Create/Edit organizational structures
 * 
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (isEditMode) {
        ...
        await structureService.create(structureData);
        setSuccess('Structure created successfully');
      }

      setTimeout(() => navigate('/administration/structures'), 1500);
    } catch (err: any) {
    ...
    <Box>
      ...
      <Box sx={{ mb: 3 }}>
        ...
        <Typography variant="body2" color="text.secondary">
          {isEditMode ? 'Update organizational structure information' : 'Add a new organizational structure'}
        </Typography>
      </Box>
