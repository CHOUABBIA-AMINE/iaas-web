  ...
  const loadFolders = async () => {
    try {
      ...
      if (selectedArchiveBoxId) {
        filteredContent = filteredContent.filter((folder: FolderDTO) => folder.archiveBoxId === selectedArchiveBoxId);
      }
    ...
    <Box>
      <Box sx={{ mb: 3 }}>
        ...
        <Typography variant="body2" color="text.secondary">
          {t('folder.subtitles.list') || 'Manage folders inside archive boxes'}
        </Typography>
      </Box>
